...
✅ Шаг 1: Создание проекта meetup
bash
django-admin startproject matchgrid
cd matchgrid
...
✅ Шаг 3: Регистрация приложений в settings.py

✅ Шаг 4: Модели данных

✅ Шаг 5: Регистрация моделей в админке

✅ Шаг 6: Создание миграций и запуск сервера
bash
...
Взаимодействия
POST /api/interactions/interact/ - Лайк/дизлайк/просмотр
...
status - статус (looking/busy/complicated/not_looking)
...
text
GET /api/users/users/?gender=F&city=Москва&min_age=20&max_age=30
Модели данных
Пользователь
Email (уникальный)
